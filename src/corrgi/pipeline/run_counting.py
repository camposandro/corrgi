    ...
    for pixel, mapping_key in resume_plan.get_remaining_map_auto_keys().items():
        ...
        auto_futures.append(
            client.submit(
                ...
                catalog_info=resume_plan.left_hc_catalog.catalog_info,
    ...
    for left_pixel, (right_pixels, mapping_keys) in resume_plan.get_remaining_map_cross_keys().items():
        ...
        cross_futures.append(
            client.submit(
                ...
                left_catalog_info=resume_plan.left_hc_catalog.catalog_info,
                right_catalog_info=resume_plan.right_hc_catalog.catalog_info,
                correlation=args.correlation,
